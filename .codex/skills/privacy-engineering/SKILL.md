...
Regulatory specifics (GDPR/CCPA/HIPAA-class regimes) live in `compliance` — this skill is the engineering practice that makes compliance achievable rather than a policy no one can actually implement.
