...
const GATES = [
  {
    key: 'engineering',
    agentType: 'sdlc-suite:solution-architect',
    brief:
  ...
  {
    key: 'operations',
    agentType: 'sdlc-suite:site-reliability',
    brief:
...
- Produce a RECOMMENDATION for a human to confirm. You do not hold deploy authority, and neither does this workflow.`,
  { agentType: 'sdlc-suite:release-manager', label: 'recommendation', phase: 'Synthesize' },
)
