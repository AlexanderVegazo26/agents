...
tools: Bash, Read, Write, Edit, Grep, Glob, TaskCreate, Agent(qa-runner), Agent(persona-runner), Agent(sdlc-suite:persona-runner), Skill, Agent(sdlc-suite:qa-runner), Artifact
