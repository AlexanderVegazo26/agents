...
Disaster recovery covers loss of infrastructure/data at a scale beyond a single incident's normal mitigation (region loss, catastrophic data corruption, ransomware) — day-to-day incident response is `incident-response`; this is the plan for when that response isn't enough.
