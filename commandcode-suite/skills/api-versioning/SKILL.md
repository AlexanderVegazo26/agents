...
Verify both directions: a new consumer against the old producer, and existing consumers against the new producer, for anything spanning a version boundary — see `sdlc-suite:qa-tooling`'s contract-testing checklist.
