...
- **Accepted** — explicitly acknowledged by someone with authority to accept it, with reasoning recorded (this is the same pattern as risk acceptance in `sdlc-suite:governance`).
