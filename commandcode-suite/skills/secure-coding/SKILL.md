...
A vulnerability in a dependency is your vulnerability once it's in production — see `sdlc-suite:dependency-health` and `sdlc-suite:supply-chain-security` for the audit side of this.
