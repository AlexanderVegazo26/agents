...
`sdlc-suite:disaster-recovery` covers getting systems back; business continuity covers whether the business can keep operating while they're down — degraded-mode processes, manual workarounds for critical functions, and communication to customers/partners during the outage.
