...
Audit trails for access to regulated data; defined retention and deletion (see `sdlc-suite:privacy-engineering`); access controls proportionate to data sensitivity; documented data flows showing where regulated data travels (including third parties/subprocessors); breach notification readiness.
