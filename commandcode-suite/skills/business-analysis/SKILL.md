...
Once the real problem and desired outcome are clear, hand off to `sdlc-suite:product-manager` for prioritization against the rest of the roadmap, or directly to `sdlc-suite:product-analyst` for requirements if priority is already established.
