...
Draw context boundaries around areas that change for the same business reason and at the same rate — this is the DDD-flavored version of the coupling/cohesion reasoning in `system-architecture`.
